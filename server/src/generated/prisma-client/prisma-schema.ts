...
export const typeDefs = /* GraphQL */ `type AggregateAlarm {
  count: Int!
}
...
type Mutation {
  ...
  upsertAlarm(where: AlarmWhereUniqueInput!, create: AlarmCreateInput!, update: AlarmUpdateInput!): Alarm!
...
type Query {
  ...
  alarms(where: AlarmWhereInput, orderBy: AlarmOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Alarm]!
  alarmsConnection(where: AlarmWhereInput, orderBy: AlarmOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): AlarmConnection!
  node(id: ID!): Node
}
